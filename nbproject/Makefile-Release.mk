...
${OBJECTDIR}/BoostGraph.o: BoostGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BoostGraph.o BoostGraph.cpp

${OBJECTDIR}/CopyFile.o: CopyFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CopyFile.o CopyFile.cpp
...
${OBJECTDIR}/GetDuringTIme.o: GetDuringTIme.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GetDuringTIme.o GetDuringTIme.cpp
...
${OBJECTDIR}/Noisy.o: Noisy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Noisy.o Noisy.cpp
...
${OBJECTDIR}/Student1.o: Student1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Student1.o Student1.cpp

${OBJECTDIR}/Urand.o: Urand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Urand.o Urand.cpp
...
${OBJECTDIR}/shared_ptr_example.o: shared_ptr_example.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shared_ptr_example.o shared_ptr_example.cpp
